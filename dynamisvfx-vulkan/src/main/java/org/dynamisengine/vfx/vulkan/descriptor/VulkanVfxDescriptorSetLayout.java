package org.dynamisengine.vfx.vulkan.descriptor;
...
public final class VulkanVfxDescriptorSetLayout {
    ...
    public static VulkanVfxDescriptorSetLayout create(long device) {
        ...
        List<DescriptorBinding> set3 = List.of(
            ...
            new DescriptorBinding(6, VK10.VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK10.VK_SHADER_STAGE_FRAGMENT_BIT),
            new DescriptorBinding(7, VK10.VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, VK10.VK_SHADER_STAGE_COMPUTE_BIT)
        );
